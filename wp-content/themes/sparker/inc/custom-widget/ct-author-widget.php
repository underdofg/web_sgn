<?php
/**
 * Sparker Author Widget.
 *
 * @since 1.0.0
 */
class Sparker_Author_Widget extends WP_Widget{
     public function __construct(){
          parent::__construct(
               'sparker-author-widget',
               __( 'CT Author', 'sparker' ),
               array( 'description' => __( 'Place anywhere in the Widget area.', 'sparker' ) )
          );
     }   
     ...
     public function form($instance ){
          ?>
          <p>
              <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Author or Ads Title', 'sparker' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e( 'Author or Ads Description', 'sparker' ); ?></label><br />
              ...
              <p>
                 ...
                 <input type="text" class="widefat custom_media_url" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php 
                  ...
                  ?>">
                 <input type="button" class="button button-primary custom_media_button" id="custom_media_button" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php esc_attr_e('Upload Image','sparker')?>" />
             </p>
             <p>
                <label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e( 'Facebook', 'sparker' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e( 'Twitter', 'sparker' ); ?></label><br />
         ...
         <p>
                <label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e( 'Google Plus', 'sparker' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e( 'Instagram', 'sparker' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e( 'Linkedin', 'sparker' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e( 'Youtube', 'sparker' ); ?></label><br />
...
add_action( 'widgets_init', 'sparker_author_widget' ); 
function sparker_author_widget(){     
    register_widget( 'Sparker_Author_Widget' );
}
